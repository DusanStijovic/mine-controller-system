...
public class TopActor extends ActorClassBase {
	...
	public TopActor(IRTObject parent, String name) {
		...
		new GuiCommuncitaion(this, "waterTenk");
		...
		new GuiCommuncitaion(this, "pumpTcp");
		...
		new GuiCommuncitaion(this, "alarmTcp");
		...
		new GuiCommuncitaion(this, "environmentTcp");
		...
		new GuiCommuncitaion(this, "tcpPumpControl");
		...
		new GuiCommuncitaion(this, "tcpWaterTunel");
