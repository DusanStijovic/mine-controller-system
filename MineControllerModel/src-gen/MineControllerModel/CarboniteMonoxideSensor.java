...
public class CarboniteMonoxideSensor extends PoolingSensor {
	...
	//--------------------- construction
	public CarboniteMonoxideSensor(IRTObject parent, String name) {
		super(parent, name);
		setClassName("CarboniteMonoxideSensor");
